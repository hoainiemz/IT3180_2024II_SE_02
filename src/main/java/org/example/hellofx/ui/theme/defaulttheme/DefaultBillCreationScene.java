...
import org.example.hellofx.ui.theme.BillCreationScene;
...
@Component
public class DefaultBillCreationScene implements BillCreationScene {
    @Autowired
...
//        table.setItems(FXCollections.observableArrayList(dataBaseService.nativeResidentQuery(query)));
    ...
    @Override
    public Scene getBillCreationScene() {
        reset();
