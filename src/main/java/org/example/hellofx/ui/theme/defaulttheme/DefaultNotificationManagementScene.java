...
import org.example.hellofx.ui.theme.NotificationManagementScene;
...
@Component
public class DefaultNotificationManagementScene implements NotificationManagementScene {
    @Autowired
    ...
    @Override
    public Scene getNotificationManagementScene() {
        reset();
