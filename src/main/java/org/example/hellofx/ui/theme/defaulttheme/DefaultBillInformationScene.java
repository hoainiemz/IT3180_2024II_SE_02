...
import org.example.hellofx.ui.theme.BillInformationScene;
...
@Component
public class DefaultBillInformationScene implements BillInformationScene {
...
//        table.setItems(FXCollections.observableArrayList(dataBaseService.nativeResidentQuery(query)));
    ...
    @Override
    public Scene getBillInformationScene(Integer billId) {
